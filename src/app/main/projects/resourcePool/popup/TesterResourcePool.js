...
const TesterResourcePool = () => {
    ...
    useEffect(() => {
      ...
      const fetchData = async () => {
        try {
          const response = await fetch("https://23t3zw1dvd.execute-api.us-east-1.amazonaws.com/dev/get_resource_by_role?role=Tester");
...
export default TesterResourcePool
