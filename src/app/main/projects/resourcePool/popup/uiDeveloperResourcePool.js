...
const UiDeveloperResourcePool = () => {
    ...
    useEffect(() => {
      ...
      const fetchData = async () => {
        try {
          const response = await fetch("https://23t3zw1dvd.execute-api.us-east-1.amazonaws.com/dev/get_resource_by_role?role=UI Developer");
                  ...
                  <div key={index} className="flex items-center justify-start py-6 pr-20 pl-4 gap-40">
                    <div className="flex items-center gap-6 pl-3">
                      <div>
                        ...
                        onChange={() => handleCheckboxChange(Developer.resource_id)}/>
                      </div>
                      <div className="flex items-center gap-3">
                        <img
                          className="rounded-full w-16 h-16"
                          src={Developer.image_url}></img>
                        <div>
...
export default UiDeveloperResourcePool
