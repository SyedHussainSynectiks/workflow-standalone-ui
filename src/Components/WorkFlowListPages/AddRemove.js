...
import hamburger from "./../../../public/assests/hamburger.png";
...
const AddRemove = () => {
    ...
    const menu = (
        <Menu>
            <Menu.Item
                key="1"
                className={`addusescaseRL ${activeButton === "Add Usecase" ? "bg-blue-500" : ""
                    }`}
            ...
            <Menu.Item
                key="2"
                className={`addusescaseRL ${activeButton === "Remove Workflow" ? "bg-blue-500" : ""
                    }`}
